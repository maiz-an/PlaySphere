        ...
        <div class="login-container">
            ...
            <div class="form-wrapper">
                ...
                <div class="form-content login-form active">
                    ...
                    <img src="images/CR7.png" alt="" class="loginimg">
                </div>
                <!-- Create Account Form -->
                    ...
                    <form action="register.php" method="post" class="signup-form" id="register">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-field">
                                ...
                                <input type="number" id="phone_number" name="phone_number" placeholder="07X XXX XXXX" min="0700000000" max="0799999999" required>
                            </div>
                        </div>
                        ...
                        <img src="images/Messi.png" alt="" class="loginimg1">
